    ...
    ui(new Ui::MainWindow)
{
    ...
    QCPTextElement *title = new QCPTextElement(ui->customPlot, "Testing oneMax function",
            QFont("sans", 17,
                  QFont::Bold));
    ...
    connect(ui->customPlot, SIGNAL(legendDoubleClick(QCPLegend *, QCPAbstractLegendItem *,
                                   QMouseEvent *)), this, SLOT(legendDoubleClick(QCPLegend *, QCPAbstractLegendItem *)));
